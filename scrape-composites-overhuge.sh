...
while : ; do
  ...
  sem --id 'factordb-curl' --fg -j 4 wget --user-agent "\"Mozilla/5.0 (X11; Linux x86_64; rv:139.0) Gecko/20100101 Firefox/139.0\"" -t 10 --retry-all-errors --retry-delay 10 -e robots=off --no-check-certificate -O- "$url"
