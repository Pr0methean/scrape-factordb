...
gnome-terminal --tab --title=PRP -- bash -c "digits=300 start=0 perpage=4 nice -+19 ./scrape-prps.sh 2>&1 | tee /tmp/scrape-prps.txt"
echo 4 > /tmp/scrape-composites-large-threads
