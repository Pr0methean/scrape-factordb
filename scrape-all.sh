...
gnome-terminal --tab --title=PRPs -- bash -c "digits=300 start=0 perpage=10 nice -+19 ./scrape-prps.sh 2>&1 | tee /tmp/scrape-prps.txt"
gnome-terminal --tab --title=Factoring -- ./scrape-composites-large.sh 2>&1 | tee /tmp/scrape-composites-large.txt
