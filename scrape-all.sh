...
gnome-terminal --tab --title=PRP -- bash -c "nice -+19 /home/ANT.AMAZON.COM/hennickc/RustroverProjects/ScrapeFactordbPrpsRust/target/release/ScrapeFactordbPrpsRust 2>&1 | tee /tmp/scrape-prps.txt"
